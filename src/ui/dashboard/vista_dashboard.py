import flet as ft
from src.services.dashboard_services import DashboardService
from src.ui.dashboard.components import grafico_mora_por_anio, metric_cards
from src.ui.dashboard.layout import build_layout
...
class VistaDashBoard:
    def __init__(self, page, context):
        ...
        self.data_table = ft.DataTable(
            columns=[
                ft.DataColumn(label=ft.Text("Año")),
                ft.DataColumn(label=ft.Text("Facturas")),
