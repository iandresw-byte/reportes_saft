...
def abrir_modal_rpt_ingresos_detallados_depto(vista, e):
    ...
    btn_pdf.on_click = vista.generar_pdf_ingreso_depto_detallado
    btn_excel.on_click = vista.generar_excel_ingreso_depto_detallado

    btn_salir = create_boton_salir_modal()

    btn_salir.on_click = lambda _: vista.cerrar_modal()
    txt_titulo = create_titulo_modal(
        'Ingresos por Departamento Detallado por Contribuyente')
