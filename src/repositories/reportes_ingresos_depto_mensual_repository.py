...
class IngresosDeptosMensualRepository:
    def __init__(self, conexion):
        self.conexion = conexion

    def obtener_mensual_catastro(self, anio: str):
        query = """SELECT month(F_03.FechaRecibo) as Mes, 
                    ...
                    WHERE (F_03.ReciboAnulado = 0) AND  (YEAR(F_03.FechaRecibo) = ?)  AND (PLA_DEPARTAMENTOS.IdDeptos = 1)
    ...
    def obtener_mensual_ics_otras(self, anio: str):
        query = """month(F_03.FechaRecibo) as Mes,
                    ...
                    F_01 ON Usuario.UsuarioCod = F_01.CreadoPor ON F_04.NumFactura = F_01.NumAvPg INNER JOIN
                    FC_03 ON F_03.DNI = FC_03.DNI
                    WHERE        (F_03.ReciboAnulado = 0) AND (YEAR(F_03.FechaRecibo) = ?) AND (PLA_DEPARTAMENTOS.IdDeptos = 2) AND (F_01.AvPgTipoImpuesto = 0)
                    GROUP BY month(F_03.FechaRecibo)
                    ORDER BY Mes
                    """
        with self.conexion.cursor() as cur:
    ...
    def obtener_mensual_ics_bienes(self, anio: str):
        query = """SELECT month(F_03.FechaRecibo) as Mes, 
                    ...
                    F_01 ON Usuario.UsuarioCod = F_01.CreadoPor ON F_04.NumFactura = F_01.NumAvPg INNER JOIN
                    FC_03 ON F_03.DNI = FC_03.DNI
                    WHERE        (F_03.ReciboAnulado = 0) AND (YEAR(F_03.FechaRecibo) = ?) AND (PLA_DEPARTAMENTOS.IdDeptos = 2)  AND (F_01.AvPgTipoImpuesto = 1)
                    and F_04.ClaveCatastro <> ''
                    GROUP BY month(F_03.FechaRecibo)
                    ORDER BY Mes"""
        with self.conexion.cursor() as cur:
            cur.execute(query, (anio,))
    ...
    def obtener_mensual_ics_comercio(self, anio: str):
        query = """
                SELECT month(F_03.FechaRecibo) as Mes, 
                ...
                WHERE        (F_03.ReciboAnulado = 0) AND (YEAR(F_03.FechaRecibo) = ?) AND (PLA_DEPARTAMENTOS.IdDeptos = 2) AND (F_01.AvPgTipoImpuesto in (2,3))
    ...
    def obtener_mensual_ics_personal(self, anio: str):
        query = """
                SELECT month(F_03.FechaRecibo) as Mes, 
                ...
                F_01 ON Usuario.UsuarioCod = F_01.CreadoPor ON F_04.NumFactura = F_01.NumAvPg INNER JOIN
                FC_03 ON F_03.DNI = FC_03.DNI
                WHERE        (F_03.ReciboAnulado = 0) AND (YEAR(F_03.FechaRecibo) = ?) AND (PLA_DEPARTAMENTOS.IdDeptos = 2) AND (F_01.AvPgTipoImpuesto = 4)
                GROUP BY month(F_03.FechaRecibo)
                ORDER BY Mes
            """
        with self.conexion.cursor() as cur:
    ...
    def obtener_mensual_uma(self, anio: str):
        query = """SELECT month(F_03.FechaRecibo) as Mes, 
                    ...
                    F_01 ON Usuario.UsuarioCod = F_01.CreadoPor ON F_04.NumFactura = F_01.NumAvPg INNER JOIN
                    FC_03 ON F_03.DNI = FC_03.DNI
                    WHERE (F_03.ReciboAnulado = 0) AND (YEAR(F_03.FechaRecibo) = ?) AND (PLA_DEPARTAMENTOS.IdDeptos = 3)
                    GROUP BY month(F_03.FechaRecibo)
                    ORDER BY Mes
                    """
        with self.conexion.cursor() as cur:
    ...
    def obtener_mensual_secretaria(self, anio: str):
        query = """SELECT month(F_03.FechaRecibo) as Mes, 
                ...
                F_01 ON Usuario.UsuarioCod = F_01.CreadoPor ON F_04.NumFactura = F_01.NumAvPg INNER JOIN
                FC_03 ON F_03.DNI = FC_03.DNI
                WHERE  (F_03.ReciboAnulado = 0) AND (YEAR(F_03.FechaRecibo) = ?) AND (PLA_DEPARTAMENTOS.IdDeptos = 6)
                GROUP BY month(F_03.FechaRecibo)
                ORDER BY Mes
                """
        with self.conexion.cursor() as cur:
    ...
    def obtener_mensual_urbanizacion(self, anio: str):
        query = """SELECT month(F_03.FechaRecibo) as Mes, 
            ...
            F_01 ON Usuario.UsuarioCod = F_01.CreadoPor ON F_04.NumFactura = F_01.NumAvPg INNER JOIN
            FC_03 ON F_03.DNI = FC_03.DNI
            WHERE        (F_03.ReciboAnulado = 0) AND (YEAR(F_03.FechaRecibo) = ?) AND (PLA_DEPARTAMENTOS.IdDeptos = 8) 
            GROUP BY month(F_03.FechaRecibo)
            ORDER BY Mes"""
        with self.conexion.cursor() as cur:
            cur.execute(query, (anio))
    ...
    def obtener_mensual_justicia(self, anio: str):
        query = """SELECT month(F_03.FechaRecibo) as Mes,
                    CAST(SUM(CASE WHEN substring(F_04.CtaIngreso, 1, 9) = '125990222' THEN F_04.ValorUnitReciboDet ELSE 0 END) AS FLOAT) AS Autorizaciones, 
                    ...
                    F_01 ON Usuario.UsuarioCod = F_01.CreadoPor ON F_04.NumFactura = F_01.NumAvPg INNER JOIN
                    FC_03 ON F_03.DNI = FC_03.DNI
                    WHERE        (F_03.ReciboAnulado = 0) AND (YEAR(F_03.FechaRecibo) = ?) AND (PLA_DEPARTAMENTOS.IdDeptos = 4) 
                    GROUP BY month(F_03.FechaRecibo)
                    ORDER BY Mes
                """
        with self.conexion.cursor() as cur:
    ...
    def obtener_mensual_procamut(self, anio: str,):
        query = """SELECT month(F_03.FechaRecibo) as Mes,
                    ...
                    F_01 ON Usuario.UsuarioCod = F_01.CreadoPor ON F_04.NumFactura = F_01.NumAvPg INNER JOIN
                    FC_03 ON F_03.DNI = FC_03.DNI
                    WHERE        (F_03.ReciboAnulado = 0) AND (YEAR(F_03.FechaRecibo) = ?) AND (PLA_DEPARTAMENTOS.IdDeptos = 7) 
                    GROUP BY month(F_03.FechaRecibo)
                    ORDER BY Mes
                """
        with self.conexion.cursor() as cur:
