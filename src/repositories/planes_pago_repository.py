class PlanesPagoRepository:
    ...
    def obtener_detalle(self, num_plan_pago: str):
        query = """SELECT PlanPagoDetalle.NumAvPg, AvPgEnc.AvPgEstado, AvPgEnc.AvPgTipoImpuesto, CAST(SUM(AvPgDetalle.ValorUnitAvPgDet) AS FLOAT) AS Monto
    ...
    def obtener_factura_cuota(self, num_plan_pago: str):
        query = """SELECT PlanPagoFactura.NumAvPg, AvPgEnc.AvPgEstado, CAST(SUM(AvPgDetalle.ValorUnitAvPgDet) AS FLOAT) AS Monto
