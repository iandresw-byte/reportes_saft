...
from src.reports.tablas.tabla_aviso_cobro import tabla_aviso_carta
from src.reports.utils.tabla_titulo_pfd import titulo_vertical
...
class ApremioCartaGobReport:
    ...
    def generar_pdf(self, ruta_salida):
        ...
        for index, contribuyente in enumerate(self.lista_datos):
            ...
            buffer.seek(0)
            tabla_duo = tabla_aviso_carta(contribuyente["mora"])
            if NUM_FIRMAS == '1':
            ...
            tabla_titulo = titulo_vertical(titulo,logo_mun,qr_flowable )
