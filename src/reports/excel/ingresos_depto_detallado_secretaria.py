...
class IngresosDeptosDetalladosSecretariaReport:
    ...
    def generar_excel(self, ruta_salida="ingresos_deptos_detallado_secretaia.xlsx"):
        wb = Workbook()
        ws = wb.active
        ...
        datos = sumar_ingresos_departo_secretaria(self.datos)
