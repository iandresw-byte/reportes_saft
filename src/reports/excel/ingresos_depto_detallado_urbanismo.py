...
class IngresosDeptosDetalladosUrbanismoReport:
    ...
    def generar_excel(self, ruta_salida="ingresos_deptos_detallado_secretaia.xlsx"):
        ...
        columnas = ["No.", "No. RECIBO",
                    ...
                    "PERMISOS DE CONSTRUCCION DE ANTENAS",
                    "INSTALACION DE RÓTULOS",
                    "CONSTANCIAS",
                    "OTROS",
                    "TOTAL"]
        ...
        datos = sumar_ingresos_depto_urbanizacion(self.datos)
