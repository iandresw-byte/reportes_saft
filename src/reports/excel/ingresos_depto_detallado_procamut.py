...
class IngresosDeptosDetalladosProcamutReport:
    ...
    def generar_excel(self, ruta_salida="ingresos_deptos_detallado_procamut.xlsx"):
        wb = Workbook()
        ws = wb.active
        ...
        datos = sumar_ingresos_depto_procamut(self.datos)
