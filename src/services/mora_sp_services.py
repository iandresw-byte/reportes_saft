...
# MORA CONTRIBUCION
    ...
    def obtener_mora_sp_gob(self):

        cta_agua = '11111801'
        cta_alcantarillado = '11111802'
        cta_tren_aseo = '11111804'
        cta_bomberos = '11111806'
        cta_limpieza_solares = '11111810'
        cta_aseo_parques = '11111811'
        cta_limpieza_cementerio = '11111812'
        cta_ambiente = '11111820'
        cta_contribucion = '22323001'
...
# MORA CONTRIBUCION
        ...
        if data_cta_contribucion:
            ...
            intereses_mora = self.repo_factura.obtener_mora_sp('11212602')
            for mora in intereses_mora:
                contado += 1
                datos_interes.append({
                    'Cuenta': mora['CtaIngreso'],
                    'Tipo': "Intereses por servicios públicos",
                    'Valor': mora['valor']
                })

            recargos_mora = self.repo_factura.obtener_mora_sp('11212102')
            for mora in recargos_mora:
                contado += 1
                datos_interes.append({
                    'Cuenta': mora['CtaIngreso'],
                    'Tipo': "Recargos por servicios públicos",
                    'Valor': mora['valor']
                })

        if not contado != 0:
            raise ValueError("No se encontraron datos de mora de sp.")
        return datos_agua, datos_alcantarillado, datos_tren, datos_bombero, datos_solares, datos_parques, datos_lim_cementerio, datos_ase_cementerio, datos_ambiente, datos_contribucuion, datos_interes
