...
class ConstanciasService:
    ...
    def insertar_licencia_uma_ics(self, data_tasa):
        tasa = data_tasa[0]
        self.constancias.insertar_tasa_uma_ics(tasa["no_licencia"],
                                                  tasa["periodo"],
                                                  tasa["dni"],
                                                  tasa["propietario"],
                                                  tasa["rtm"],
                                                  tasa["establecimiento"],
                                                  tasa["direccion_establecimento"],
                                                  tasa["num_recibo"],
                                                  tasa["fecha_solicitud"],
                                                  tasa["fecha_vence"])

    def update_tasa_ambiental(self, data_tasa):
        tasa = data_tasa[0]
        self.constancias.update_tasa_uma_ics(tasa["no_licencia"],
                                                    tasa["periodo"],
                                                    tasa["dni"],
                                                    tasa["propietario"],
                                                    tasa["rtm"],
