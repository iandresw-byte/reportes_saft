...
from src.repositories.permiso_operacion_repository import PermisoOperacionReposirory
...
class PermisooperacionServices:
    ...
    def reporte_permiso_operacion(self, fecha_ini, fecha_fin, cod_aldea, cod_barrio, tipo_po):
        data = self.repo.reporte_permisos_operacion(
            fecha_ini, fecha_fin, cod_aldea, cod_barrio, tipo_po)
        if not data:
            data = self.repo.reporte_permisos_operacion_cta(
                fecha_ini, fecha_fin, cod_aldea, cod_barrio)
        return data
