CONSULTA_APREMIO_GOB_NAT_TODOS_GOB= """
...
GROUP BY  FC_03.DNI, FC_03.Pnombre, FC_03.SNombre, FC_03.PApellido, FC_03.SApellido, FC_03.Direccion, FC_03.ClaveCatastro, FC_03.CodBarrio, FC_03.CodAldea
HAVING CAST(SUM(F_02.ValorUnitAvPgDet) AS FLOAT)  > @ValorUnitAvPgDet
ORDER BY  FC_03.DNI;
"""

CONSULTA_APREMIO_GOB_NAT_TODOS_GOB_AVISO = """
DECLARE @Cantidad_filas INT = ?
DECLARE @FechaVenceAvPg DATE = ?
DECLARE @AvPgTipoImpuesto VARCHAR(1) =?
DECLARE @Tipo VARCHAR(1) =?
...
CONSULTA_APREMIO_GOB_NAT_TODOS_SAMI= """
DECLARE @Cantidad_filas INT = ?
DECLARE @FechaVenceAvPg DATE = ?
DECLARE @AvPgTipoImpuesto VARCHAR(1) =?
DECLARE @Tipo VARCHAR(1) =?
DECLARE @CodBarrio VARCHAR(?) =  ?
DECLARE @CodAldea VARCHAR(?) =?
