import flet as ft
from src.views.layout_view import UILayout
from src.utils.credenciales import ManejadorCredenciales
from src.ui.components.ui_text import text_usuario, text_usuario_password
from src.ui.components.ui_colors import color_bg, color_bg_2, color_texto,  color_texto_parrafo
...
class PantallaLogin:
    ...
    async def configurar_ventana(self):
        self.page.padding = 0
    ...
    def construir_formulario(self):
        return ft.Column([
            ...
            ft.Row([ft.Container(ft.Image(src='/images/saft.png', width=50, height=40)), ft.Container(ft.Image(
                src='/images/Logo_amhon.png', width=100, height=90))], alignment=ft.MainAxisAlignment.CENTER),
    ...
    def construir_panel_bienvenida(self):
        return ft.Column([
            ...
            ft.Container(ft.Image(src='/images/img-login.png', width=300)),
        ],
            alignment=ft.MainAxisAlignment.CENTER,
            horizontal_alignment=ft.CrossAxisAlignment.CENTER)
